...
namespace BanCore
{
    ...
    public partial class CoreDbEntities : DbContext
    {
        ...
        public virtual DbSet<transactions1> transactions1Set { get; set; }
        ...
        public virtual int InsertOrUpdateTransaction(Nullable<int> id, Nullable<int> payerId, string payerAccount, string payerIdentification, Nullable<int> payeeId, string payeeAccount, string payeeIdentification, Nullable<int> payeeBankId, Nullable<int> transactionTypeId, string number, string concept, Nullable<double> amount, Nullable<int> currencyTypeId, string referenceNumber, Nullable<System.DateTime> effectiveDate, Nullable<double> payerBalance, Nullable<double> payeeBalance, Nullable<int> statusId, ObjectParameter newId)
        {
            var idParameter = id.HasValue ?
                new ObjectParameter("Id", id) :
                new ObjectParameter("Id", typeof(int));
            ...
            var payerBalanceParameter = payerBalance.HasValue ?
                new ObjectParameter("PayerBalance", payerBalance) :
                new ObjectParameter("PayerBalance", typeof(double));
    
            var payeeBalanceParameter = payeeBalance.HasValue ?
                new ObjectParameter("PayeeBalance", payeeBalance) :
                new ObjectParameter("PayeeBalance", typeof(double));
    
            var statusIdParameter = statusId.HasValue ?
                new ObjectParameter("StatusId", statusId) :
                new ObjectParameter("StatusId", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("InsertOrUpdateTransaction", idParameter, payerIdParameter, payerAccountParameter, payerIdentificationParameter, payeeIdParameter, payeeAccountParameter, payeeIdentificationParameter, payeeBankIdParameter, transactionTypeIdParameter, numberParameter, conceptParameter, amountParameter, currencyTypeIdParameter, referenceNumberParameter, effectiveDateParameter, payerBalanceParameter, payeeBalanceParameter, statusIdParameter, newId);
        }
        ...
        public virtual ObjectResult<getusers2_Result> getusers2(Nullable<int> id, string userName, string email, Nullable<int> clientId)
        {
            var idParameter = id.HasValue ?
                new ObjectParameter("Id", id) :
                new ObjectParameter("Id", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<getusers2_Result>("getusers2", idParameter, userNameParameter, emailParameter, clientIdParameter);
        }
    
        public virtual ObjectResult<ValidateEmpUserCredentials1_Result> ValidateEmpUserCredentials1(string userName, string password)
        {
            var userNameParameter = userName != null ?
                new ObjectParameter("UserName", userName) :
                new ObjectParameter("UserName", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<ValidateEmpUserCredentials1_Result>("ValidateEmpUserCredentials1", userNameParameter, passwordParameter);
        }
    
        public virtual ObjectResult<ValidateEmpUserCredentials2_Result> ValidateEmpUserCredentials2(string userName, string password)
        {
            var userNameParameter = userName != null ?
                new ObjectParameter("UserName", userName) :
                new ObjectParameter("UserName", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<ValidateEmpUserCredentials2_Result>("ValidateEmpUserCredentials2", userNameParameter, passwordParameter);
        }
    
        public virtual int ValidateEmpUserCredentials3(string userName, string password)
        {
            var userNameParameter = userName != null ?
                new ObjectParameter("UserName", userName) :
                new ObjectParameter("UserName", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("ValidateEmpUserCredentials3", userNameParameter, passwordParameter);
        }
    
        public virtual ObjectResult<Nullable<int>> ValidateEmpUserCredentials4(string userName, string password)
        {
            var userNameParameter = userName != null ?
                new ObjectParameter("UserName", userName) :
                new ObjectParameter("UserName", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<int>>("ValidateEmpUserCredentials4", userNameParameter, passwordParameter);
        }
    
        public virtual ObjectResult<Nullable<int>> ValidateUserCredentials1(string userName, string password)
        {
            var userNameParameter = userName != null ?
                new ObjectParameter("UserName", userName) :
                new ObjectParameter("UserName", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<int>>("ValidateUserCredentials1", userNameParameter, passwordParameter);
        }
    
        public virtual ObjectResult<getaccounts1_Result> getaccounts1(Nullable<int> accountId, string accountNumber, Nullable<int> clientId, Nullable<int> currencyTypeId)
        {
            var accountIdParameter = accountId.HasValue ?
                new ObjectParameter("AccountId", accountId) :
                new ObjectParameter("AccountId", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<getaccounts1_Result>("getaccounts1", accountIdParameter, accountNumberParameter, clientIdParameter, currencyTypeIdParameter);
        }
    
        public virtual ObjectResult<gettransactions1_Result> gettransactions1(Nullable<int> id, Nullable<int> payerId, string payerAccount, string payerIdentification, Nullable<int> payeeId, string payeeAccount, string payeeIdentification, string transactionNumber, string referenceNumber, Nullable<System.DateTime> creationDateFrom, Nullable<System.DateTime> creationDateTo, Nullable<System.DateTime> effectiveDateFrom, Nullable<System.DateTime> effectiveDateTo)
        {
            var idParameter = id.HasValue ?
                new ObjectParameter("Id", id) :
                new ObjectParameter("Id", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<gettransactions1_Result>("gettransactions1", idParameter, payerIdParameter, payerAccountParameter, payerIdentificationParameter, payeeIdParameter, payeeAccountParameter, payeeIdentificationParameter, transactionNumberParameter, referenceNumberParameter, creationDateFromParameter, creationDateToParameter, effectiveDateFromParameter, effectiveDateToParameter);
        }
    
        public virtual ObjectResult<getaccounts2_Result> getaccounts2(Nullable<int> accountId, string accountNumber, Nullable<int> clientId, Nullable<int> currencyTypeId)
        {
            var accountIdParameter = accountId.HasValue ?
                new ObjectParameter("AccountId", accountId) :
                new ObjectParameter("AccountId", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<getaccounts2_Result>("getaccounts2", accountIdParameter, accountNumberParameter, clientIdParameter, currencyTypeIdParameter);
        }
    
        public virtual ObjectResult<gettransactions2_Result> gettransactions2(Nullable<int> id, Nullable<int> payerId, string payerAccount, string payerIdentification, Nullable<int> payeeId, Nullable<int> payeeProductTypeId, string payeeProductNumber, string payeeIdentification, string transactionNumber, string referenceNumber, Nullable<System.DateTime> creationDateFrom, Nullable<System.DateTime> creationDateTo, Nullable<System.DateTime> effectiveDateFrom, Nullable<System.DateTime> effectiveDateTo)
        {
            var idParameter = id.HasValue ?
                new ObjectParameter("Id", id) :
                new ObjectParameter("Id", typeof(int));
            ...
            var payeeProductTypeIdParameter = payeeProductTypeId.HasValue ?
                new ObjectParameter("PayeeProductTypeId", payeeProductTypeId) :
                new ObjectParameter("PayeeProductTypeId", typeof(int));
    
            var payeeProductNumberParameter = payeeProductNumber != null ?
                new ObjectParameter("PayeeProductNumber", payeeProductNumber) :
                new ObjectParameter("PayeeProductNumber", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<gettransactions2_Result>("gettransactions2", idParameter, payerIdParameter, payerAccountParameter, payerIdentificationParameter, payeeIdParameter, payeeProductTypeIdParameter, payeeProductNumberParameter, payeeIdentificationParameter, transactionNumberParameter, referenceNumberParameter, creationDateFromParameter, creationDateToParameter, effectiveDateFromParameter, effectiveDateToParameter);
        }
    
        public virtual int InsertOrUpdateTransaction1(Nullable<int> id, Nullable<int> payerId, string payerAccount, string payerIdentification, Nullable<int> payeeId, Nullable<int> payeeProductTypeId, string payeeProductNumber, string payeeIdentification, Nullable<int> payeeBankId, Nullable<int> transactionTypeId, string number, string concept, Nullable<double> amount, Nullable<int> currencyTypeId, string referenceNumber, Nullable<System.DateTime> effectiveDate, Nullable<double> payerBalance, Nullable<double> payeeBalance, Nullable<int> statusId, ObjectParameter newId)
        {
            var idParameter = id.HasValue ?
                new ObjectParameter("Id", id) :
                new ObjectParameter("Id", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("InsertOrUpdateTransaction1", idParameter, payerIdParameter, payerAccountParameter, payerIdentificationParameter, payeeIdParameter, payeeProductTypeIdParameter, payeeProductNumberParameter, payeeIdentificationParameter, payeeBankIdParameter, transactionTypeIdParameter, numberParameter, conceptParameter, amountParameter, currencyTypeIdParameter, referenceNumberParameter, effectiveDateParameter, payerBalanceParameter, payeeBalanceParameter, statusIdParameter, newId);
        }
    
        public virtual int InsertOrUpdateTransaction2(Nullable<int> id, Nullable<int> payerId, string payerAccount, string payerIdentification, Nullable<int> payeeId, Nullable<int> payeeProductTypeId, string payeeProductNumber, string payeeIdentification, Nullable<int> payeeBankId, Nullable<int> transactionTypeId, string number, string concept, Nullable<double> amount, Nullable<int> currencyTypeId, string referenceNumber, Nullable<System.DateTime> effectiveDate, Nullable<double> payerBalance, Nullable<double> payeeBalance, Nullable<int> statusId, ObjectParameter newId)
        {
            var idParameter = id.HasValue ?
                new ObjectParameter("Id", id) :
                new ObjectParameter("Id", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("InsertOrUpdateTransaction2", idParameter, payerIdParameter, payerAccountParameter, payerIdentificationParameter, payeeIdParameter, payeeProductTypeIdParameter, payeeProductNumberParameter, payeeIdentificationParameter, payeeBankIdParameter, transactionTypeIdParameter, numberParameter, conceptParameter, amountParameter, currencyTypeIdParameter, referenceNumberParameter, effectiveDateParameter, payerBalanceParameter, payeeBalanceParameter, statusIdParameter, newId);
        }
    
        public virtual int InsertOrUpdateAccount2(Nullable<int> id, string alias, string number, Nullable<int> ownerId, Nullable<int> accountTypeId, Nullable<int> accountManagerId, Nullable<int> currencyTypeId, Nullable<int> statusId, Nullable<double> balance, ObjectParameter newId)
        {
            var idParameter = id.HasValue ?
                new ObjectParameter("Id", id) :
                new ObjectParameter("Id", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("InsertOrUpdateAccount2", idParameter, aliasParameter, numberParameter, ownerIdParameter, accountTypeIdParameter, accountManagerIdParameter, currencyTypeIdParameter, statusIdParameter, balanceParameter, newId);
        }
    
        public virtual int InsertOrUpdateAccount3(Nullable<int> id, string alias, string number, Nullable<int> ownerId, Nullable<int> accountTypeId, Nullable<int> accountManagerId, Nullable<int> currencyTypeId, Nullable<int> statusId, Nullable<double> balance, ObjectParameter newId)
        {
            var idParameter = id.HasValue ?
                new ObjectParameter("Id", id) :
                new ObjectParameter("Id", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("InsertOrUpdateAccount3", idParameter, aliasParameter, numberParameter, ownerIdParameter, accountTypeIdParameter, accountManagerIdParameter, currencyTypeIdParameter, statusIdParameter, balanceParameter, newId);
        }
    }
}
