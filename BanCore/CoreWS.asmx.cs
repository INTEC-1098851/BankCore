...
namespace BanCore
{
    ...
    public class CoreWS : System.Web.Services.WebService
    {
        ...
        public List<Transaction> FilterTransaction(int? payerId, string payerAccount = null, string payerIdentication = null,
            ...
            => _transactionService.FilterBy(payerId, payerAccount, payerIdentication, payeeId, 
                payeeProductTypeId,payeeProductNumber,payeeIdentification, creationDateFrom, creationDateTo, 
