...
namespace CoreBll
{
    ...
    public class Card
    {
        ...
        public string CutOffDateStr { get { return CutOffDate.ToString("dd-MM-yyyy"); } }
        public DateTime PaymentLimitDate { get; set; }
        public string PaymentLimitDateStr { get { return PaymentLimitDate.ToString("dd-MM-yyyy"); } }
        ...
        public string LastPaymentDateStr { get { return LastPaymentDate.ToString("dd-MM-yyyy"); } }
